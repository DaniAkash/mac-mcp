...
import { TOOL as getEmailAttachmentTool } from "../../server/tools/mail/getEmailAttachment.ts";
import { TOOL as getEmailAttachmentsTool } from "../../server/tools/mail/getEmailAttachments.ts";
